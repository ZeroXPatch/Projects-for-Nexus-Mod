...
namespace SunriseTransitions
{
    public class ModEntry : Mod
    {
        ...
        private struct VisualSettings
        {
            ...
            public int Duration;
            public int StartTime; // New field for Peak Time
        }
        ...
        private void UpdateActiveSettings()
        {
            ...
            {
                case "summer":
                    ActiveSettings = new VisualSettings { R = Config.SummerR, G = Config.SummerG, B = Config.SummerB, Intensity = Config.SummerIntensity, Duration = Config.SummerDuration, StartTime = Config.SummerStartTime };
                    break;
                case "fall":
                    ActiveSettings = new VisualSettings { R = Config.FallR, G = Config.FallG, B = Config.FallB, Intensity = Config.FallIntensity, Duration = Config.FallDuration, StartTime = Config.FallStartTime };
                    break;
                case "winter":
                    ActiveSettings = new VisualSettings { R = Config.WinterR, G = Config.WinterG, B = Config.WinterB, Intensity = Config.WinterIntensity, Duration = Config.WinterDuration, StartTime = Config.WinterStartTime };
                    break;
                default: // spring
                    ActiveSettings = new VisualSettings { R = Config.SpringR, G = Config.SpringG, B = Config.SpringB, Intensity = Config.SpringIntensity, Duration = Config.SpringDuration, StartTime = Config.SpringStartTime };
                    break;
            }
        }
        ...
        private float GetSunriseOpacity()
        {
            ...
            // Use the Configured Start Time (e.g., 400 or 600)
            int startTime = ActiveSettings.StartTime;
            ...
            // Before Start Time? Show Max Intensity.
            // This ensures people who wake up BEFORE the configured sunrise still see the glow.
            if (elapsed < 0) return ActiveSettings.Intensity;

            // Passed Duration? Show nothing.
        ...
        private void OnGameLaunched(object? sender, GameLaunchedEventArgs e)
        {
            ...
            AddSeasonConfig(configMenu, "spring",
                ...
                () => Config.SpringIntensity, v => Config.SpringIntensity = v, () => Config.SpringDuration, v => Config.SpringDuration = v, () => Config.SpringStartTime, v => Config.SpringStartTime = v);
            ...
            AddSeasonConfig(configMenu, "summer",
                ...
                () => Config.SummerIntensity, v => Config.SummerIntensity = v, () => Config.SummerDuration, v => Config.SummerDuration = v, () => Config.SummerStartTime, v => Config.SummerStartTime = v);

            AddSeasonConfig(configMenu, "fall",
                () => Config.FallR, v => Config.FallR = v, () => Config.FallG, v => Config.FallG = v, () => Config.FallB, v => Config.FallB = v,
                () => Config.FallIntensity, v => Config.FallIntensity = v, () => Config.FallDuration, v => Config.FallDuration = v, () => Config.FallStartTime, v => Config.FallStartTime = v);
            ...
            AddSeasonConfig(configMenu, "winter",
                ...
                () => Config.WinterIntensity, v => Config.WinterIntensity = v, () => Config.WinterDuration, v => Config.WinterDuration = v, () => Config.WinterStartTime, v => Config.WinterStartTime = v);
        }
        ...
        private void AddSeasonConfig(IGenericModConfigMenuApi menu, string seasonKey,
            ...
            Func<int> getStart, Action<int> setStart)
        {
            ...
            menu.AddNumberOption(
                mod: ModManifest,
                getValue: () => (int)(getInt() * 100),
                setValue: v => setInt(v / 100f),
            ...
            menu.AddNumberOption(
                ...
                getValue: getStart,
                setValue: setStart,
                name: () => Helper.Translation.Get("config.starttime.name"),
                tooltip: () => Helper.Translation.Get("config.starttime.desc"),
                min: 400, max: 1200, interval: 10 // 4 AM to 12 PM
            );
            ...
            menu.AddNumberOption(
                ...
                getValue: getDur,
                setValue: setDur,
                name: () => Helper.Translation.Get("config.duration.name"),
                tooltip: () => Helper.Translation.Get("config.duration.desc"),
                min: 0, max: 360, interval: 10
            );
        }
    }
}