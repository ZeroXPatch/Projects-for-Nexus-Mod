...
namespace GoToBed
{
    public class ModConfig
    {
        ...
        // -- New Option for Multiplayer Support --
        // If true, dynamically finds the player's bed. If false, uses the manual coordinates below.
        public bool WarpToBed { get; set; } = true;
